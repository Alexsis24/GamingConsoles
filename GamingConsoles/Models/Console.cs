...
namespace GamingConsoles.Models
{
    ...
    {
        public string SystemName { get; set; } //name of console
        ...
        public string SystemType { get; set; } //typ of system, example: home, handheld, VR, etc
        // use systemtype to sort the consoles into the proper categories
        public int UnitsSold { get; set; } //lifetime unit sales total
        ...
        public string CpuBitBandwitchSize { get; set; } //how many "bits" does the cpu have.
        ...
        public string RemovableStorageType { get; set; } //type of removable storage
